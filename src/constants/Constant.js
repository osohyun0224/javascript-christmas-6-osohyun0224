...
export { WOOTECO_MENU_PRICES, D_DAY_DISCOUNT, WOOTECO_MAIN_MENUS, WOOTECO_DESSERT_MENUS, SPECIAL_DISCOUNT_DAYS, SPECIAL_DISCOUNT_AMOUNT, GIVEAWAY_EVENT_THRESHOLD, GIVEAWAY_ITEM };